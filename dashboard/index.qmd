...
# Colores en tonos azules
color_map_azules = {
    'Cobertura de agua >70%': '#154360',   # azul profundo (abundancia)
    'Cobertura de agua 50-70%': '#5dade2',  # azul equilibrado (normal)
    'Cobertura de agua <50%': '#d6eaf8',   # azul muy claro (escasez)
}
